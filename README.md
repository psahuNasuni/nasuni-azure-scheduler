...
4. #### Create secret Vault 
    ...
    **Create via Azure Portal**
    ...
    3. Create secrets or key value pairs with the following:
        ...
        |13|use_private_ip|Y|(Optinal)If you want to provision the infrastructure in a Private subnet, add the instruction with use_private_ip. All resources will be provisioned in the provided Private vNet, if the value passed as "Y". If this variable is not provided Or passed as "" or "N", the execution will happen in the Default Public Subnet.|
